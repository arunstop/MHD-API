...
class SymptomModel   extends CI_Model
{
    public function getSymptom($dataArr)
    {
        ...
        $sql = "SELECT tgd.id_gejala_detail, tgd.ID_GEJALA, tgd.ID_PENYAKIT, mg.NAMA_GEJALA, mp.NAMA_PENYAKIT, tgd.yes, tgd.no
        ...
        $this->db->select('tgd.id_gejala_detail, tgd.ID_GEJALA, tgd.ID_PENYAKIT, mg.NAMA_GEJALA, mp.NAMA_PENYAKIT, tgd.yes, tgd.no');
